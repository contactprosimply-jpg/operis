      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#0a1f6e]/50 border border-blue-500/20 rounded-2xl p-8">
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-4">
              <label className="font-mono text-[10px] text-slate-500 uppercase tracking-widest block mb-1.5">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div className="mb-6">
              <label className="font-mono text-[10px] text-slate-500 uppercase tracking-widest block mb-1.5">Mot de passe</label>
              <input
                type="password"
                value={password}
          ...
          <div className="mt-5 text-center">
            ...
            <a href="/register" className="text-xs text-blue-400 hover:text-blue-300">Créer un compte</a>
          </div>
        </div>
      </div>
    </div>
