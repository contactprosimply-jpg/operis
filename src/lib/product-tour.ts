...
export const PRODUCT_TOUR_STEPS: ProductTourStep[] = [
  ...
  },
  {
    ...
    body: 'AO actifs, taux de réponse fournisseurs, devis à rattacher et taux de réussite — tout votre pilotage commercial en un coup d’œil.',
    placement: 'bottom',
  },
  {
    id: 'actions',
    ...
    body: 'Operis vous dit quoi faire : relances à envoyer, consultations à lancer, devis à rattacher. Chaque bouton ouvre directement la bonne action.',
    placement: 'top',
  },
  {
    id: 'ao-table',
    ...
    title: 'AO en cours',
    body: 'Les AO les plus urgents. Cliquez sur l’un d’eux pour ouvrir le dossier : fournisseurs, devis, documents et comparatif.',
    placement: 'left',
  },
  {
    id: 'nav-tenders',
